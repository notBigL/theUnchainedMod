...
public class LawOfInertia extends AbstractDynamicCard {
    ...
    public static final String ID = TheUnchainedMod.makeID(LawOfInertia.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new AccelerationPower(p, p, magicNumber)));
    }
}
