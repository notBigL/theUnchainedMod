...
public class GlyphBrandPower extends AbstractPower {
    ...
    public void onSpecificTrigger() {
        ...
        AbstractDungeon.actionManager.addToBottom(new DamageAction(this.owner, new DamageInfo(this.source, this.amount, DamageInfo.DamageType.HP_LOSS), AbstractGameAction.AttackEffect.NONE));
    }
