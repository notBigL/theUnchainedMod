...
public class ChainSawSlashEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float sX;
    private float sY;
    ...
    private final static Texture IMG = loadImage(makeVFXPath("Chainsaw_Slash_Effect.png"));

    public ChainSawSlashEffect(float x, float y, float dX, float dY, float angle, Color color1, Color color2) {
        this(x, y, dX, dY, angle, 2.0F, color1, color2);
    }

    public ChainSawSlashEffect(float x, float y, float dX, float dY, float angle, float targetScale, Color color1, Color color2) {
