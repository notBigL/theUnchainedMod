...
public class ExhaustEmbersForRoyalDecreeEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vX;
    private float vY;
    ...
    public ExhaustEmbersForRoyalDecreeEffect(float x, float y) {
        ...
        this.vX = MathUtils.random(-75.0F * Settings.scale, 75.0F * Settings.scale);
        this.vY = MathUtils.random(-50.0F * Settings.scale, 150.0F * Settings.scale);
        this.x = x + MathUtils.random(-85.0F * Settings.scale, 85.0F * Settings.scale);
        this.y = y + MathUtils.random(-110.0F * Settings.scale, 75.0F * Settings.scale);
        this.scale = 0.01F;
