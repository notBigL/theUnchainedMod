...
import static theUnchainedMod.TheUnchainedMod.makeOrbPath;

public class DefaultOrb extends CustomOrb {

    // Standard ID/Description
    public static final String ORB_ID = TheUnchainedMod.makeID("DefaultOrb");
